...
def _parse_iso_timestamp(ts: str) -> datetime:
    ...
    asyncpg requires native Python datetime objects for TIMESTAMPTZ columns —
    raw ISO strings will throw a dbapi error.
    """
...
async def get_stats(
    ...
    if duration_rows:
        total_seconds = sum(
            (row["last_hit"] - row["first_hit"]).total_seconds()
